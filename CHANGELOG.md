...
Full release notes with changelogs per version live on the **[GitHub Releases page](https://github.com/Edcko/Mneme/releases)**.
...
- **feat(cli):** add `mneme projects list|consolidate|prune` commands for project hygiene
