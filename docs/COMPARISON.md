...
[claude-mem](https://github.com/thedotmack/claude-mem) is a great project (28K+ stars!) that inspired Mneme. But we made fundamentally different design decisions:
...
| **Web UI** | Terminal TUI (`mneme tui`) | Web viewer on localhost:37777 |
...
**Mneme** lets the agent decide what's worth remembering. The agent already has the LLM, the context, and understands what just happened. Why run a separate compression pipeline?
