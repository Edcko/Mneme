---
name: mneme-visual-language
description: >
  Visual language rules for Mneme surfaces. Trigger: Any dashboard styling,
...
1. The dashboard must feel like Mneme, not a generic SaaS admin.
